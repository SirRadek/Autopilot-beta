  ...
  return (
    <div className="cockpit-shell">
      ...
      <div className="mobile-panels">
        <section id="tab-panel-approval" className="cockpit-pane tab-panel" role="tabpanel" aria-labelledby="tab-approval" hidden={activeTab !== "approval"}>{approvalPane}</section>
        <section id="tab-panel-sessions" className="cockpit-pane tab-panel" role="tabpanel" aria-labelledby="tab-sessions" hidden={activeTab !== "sessions"}>{sessionsPane ?? projectsPane}</section>
        <section id="tab-panel-providers" className="cockpit-pane tab-panel" role="tabpanel" aria-labelledby="tab-providers" hidden={activeTab !== "providers"}>{providersPane}</section>
        <section id="tab-panel-workers" className="cockpit-pane tab-panel" role="tabpanel" aria-labelledby="tab-workers" hidden={activeTab !== "workers"}>{workersPane ?? operationsPane}</section>
      </div>
    </div>
  );
}
