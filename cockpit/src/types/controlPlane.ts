...
export interface ProviderModelRoute { readonly provider: string; readonly reasoning_efforts: readonly RunReasoningEffort[]; readonly available?: boolean; readonly health?: readonly string[]; readonly source?: "live_snapshot" | "static_fallback" | "mixed" }
...
export interface ProviderHealth { readonly providers: readonly { readonly provider: string; readonly health: string; readonly freshness: string; readonly fetched_at: string; readonly next_poll_at: string | null; readonly error_code: string | null; readonly lease: ProviderProbeLeaseState }[] }
