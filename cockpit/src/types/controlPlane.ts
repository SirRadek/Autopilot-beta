...
export interface ProviderModels { readonly freshness: string; readonly fetched_at: string | null; readonly next_poll_at: string | null; readonly models: readonly { readonly model_id: string; readonly providers: readonly string[]; readonly configured?: boolean; readonly observed?: boolean; readonly available: boolean; readonly health: readonly string[]; readonly source?: "live_snapshot" | "static_fallback" | "mixed"; readonly reasoning_efforts: readonly RunReasoningEffort[]; readonly provider_routes?: readonly ProviderModelRoute[]; readonly fetched_at?: string | null; readonly updated_at?: string | null }[] }
