...
export interface ProviderHealth { readonly providers: readonly { readonly provider: string; readonly health: string; readonly freshness: string; readonly fetched_at: string; readonly next_poll_at: string | null; readonly cli_version?: string | null; readonly error_code: string | null; readonly lease: ProviderProbeLeaseState }[] }
