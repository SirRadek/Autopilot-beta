  ...
  return <div className="rules-view">
    ...
    <div className="rules-grid">
      ...
      <section className="cockpit-card rules-section planned" aria-labelledby={id("mesh")}>
        <h3 id={id("mesh")}>Pravidla (Decision Mesh) <span className="planned-badge">Plánováno</span></h3>
        <p className="planned-note">Živý stav pravidel z mesh: plánováno (bez endpointu).</p>
      ...
      <section className="cockpit-card rules-section planned" aria-labelledby={id("skills")}>
        <h3 id={id("skills")}>Skills (prompt-library) <span className="planned-badge">Plánováno</span></h3>
        <p className="planned-note">Katalog skills a výběr pro jednotlivé běhy: plánováno. Skills se dnes vážou k běhům přes důkazy schválení.</p>
      </section>
    </div>
  </div>;
}
