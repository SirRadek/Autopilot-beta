...
describe("RunDetailView", () => {
  ...
  it("shows an empty state without a selected run", () => { const { host, root } = mount(undefined); expect(host.textContent).toContain("Vyber běh v řídicím centru."); expect(host.textContent).not.toContain("inspector-slot"); act(() => root.unmount()); host.remove(); });
