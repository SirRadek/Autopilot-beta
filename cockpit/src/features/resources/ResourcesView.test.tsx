...
function mount() {
  ...
  act(() => root.render(<ResourcesView providersPane={<p>PROVIDERS</p>} workersPane={<p>WORKERS</p>} sessionsPane={<p>SESSIONS</p>} projectsPane={<p>PROJECTS</p>} />));
  return { host, root };
}

describe("ResourcesView", () => {
  it("renders all four panes inside titled cards under the capacity header", () => {
