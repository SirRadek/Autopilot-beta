...
appendStateFile(stateDir, join(stateDir, "control-plane-audit.jsonl"), `${JSON.stringify({ at: new Date().toISOString(), action: "worker_cancel", worker_run_id: workerRunId, pid: active.pid, killed })}\n`);
